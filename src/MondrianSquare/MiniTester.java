...
class Part1Test {   // =======  12 points =======
    @Test
    @Tag("score:1")
    @DisplayName("assignment3.Block constructor test1")
    ...
    @Test
    @Tag("score:3")
    @DisplayName("assignment3.Block constructor test2")
    ...
    @Test
    @DisplayName("assignment3.Block constructor test3")
    ...
    @Test
    @Tag("score:3")
    @DisplayName("assignment3.Block updateSizeAndPosition() test1")
    ...
    @Test
    @Tag("score:1")
    @DisplayName("assignment3.Block updateSizeAndPosition() test2")
    ...
    @Test
    @DisplayName("assignment3.Block updateSizeAndPosition() test3")
    ...
    @Test
    @Tag("score:2")
    @DisplayName("assignment3.Block getBlocksToDraw() test1")
    ...
    @Test
    @Tag("score:2")
    @DisplayName("assignment3.Block getBlocksToDraw() test2")
...
class Part2Test {  // ========= 12 points =========
    @Test
    @Tag("score:2")
    @DisplayName("assignment3.Block getSelectedBlock() test1")
    ...
    @Test
    @Tag("score:2")
    @DisplayName("assignment3.Block getSelectedBlock() test2")
    ...
    @Test
    @Tag("score:2")
    @DisplayName("assignment3.Block getSelectedBlock() test3")
    ...
    @Test
    @Tag("score:2")
    @DisplayName("assignment3.Block getSelectedBlock() test4")
    ...
    @Test
    @Tag("score:1")
    @DisplayName("assignment3.Block reflect() test1")
    void reflect1() {
        Block b = new Block(0, 0, 0, 0, 2, null, new Block[0]);
    ...
    @Test
    @Tag("score:1")
    @DisplayName("assignment3.Block reflect() test2")
    ...
    @Test
    @DisplayName("assignment3.Block reflect() test3")
    ...
    @Test
    @Tag("score:1")
    @DisplayName("assignment3.Block rotate() test1")
    void rotate1() {
        Block b = new Block();
    ...
    @Test
    @Tag("score:1")
    @DisplayName("assignment3.Block rotate() test2")
    ...
    @Test
    @DisplayName("assignment3.Block rotate() test3")
    ...
    @Test
    @Tag("score:1")
    @DisplayName("assignment3.Block smash() test1")
    void smash1() {
        Block b = new Block();
    ...
    @Test
    @Tag("score:1")
    @DisplayName("assignment3.Block smash() test2")
    ...
    // smash root level
    @Test
    @DisplayName("assignment3.Block smash() test3")
    void smash3() {
        Block.gen = new Random(0);
    ...
    // smash leaf
    @Test
    @DisplayName("assignment3.Block smash() test4")
    void smash4() {
        Block.gen = new Random(0);
...
class Part3Test {  // ======== 16 points ========
    ...
    @Tag("score:2")
    @DisplayName("assignment3.Block flatten() test1")
    void Blockflatten1() {
    ...
    @Test
    @Tag("score:1")
    @DisplayName("assignment3.Block flatten() test2")
    void Blockflatten2() {
        Block[] children = new Block[4];
    ...
    @Test
    @Tag("score:3")
    @DisplayName("assignment3.Block flatten() test3")
    void Blockflatten3() {
        Block[] children = new Block[4];
    ...
    @Test
    @DisplayName("assignment3.Block flatten() test4")
    void Blockflatten4() {
    ...
    @Test
    @DisplayName("assignment3.Block flatten() test5")
    void Blockflatten5() {
        Block b = new Block(0, 10);
    ...
    @Test
    @DisplayName("assignment3.Block flatten() test6")
    void Blockflatten6() {
